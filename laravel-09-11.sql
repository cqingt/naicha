...
CREATE TABLE `formulas` (
  ...
  `package_num` tinyint(1) NOT NULL DEFAULT '1' COMMENT '订单中的第几杯',
  `title` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '配方名称',
  `likes` int(11) NOT NULL DEFAULT '0' COMMENT '点赞数',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='配方表';

-- ----------------------------
-- Records of formulas
-- ----------------------------
INSERT INTO `formulas` VALUES ('1', '1', '1', '29', '1', '1茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '1', '2018-09-11 09:43:01', '2018-09-11 17:29:19');
INSERT INTO `formulas` VALUES ('2', '1', '1', '29', '1', '2茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '1', '2018-09-11 09:43:01', '2018-09-11 16:59:37');
INSERT INTO `formulas` VALUES ('3', '1', '1', '29', '1', '3茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '1', '2018-09-11 09:43:01', '2018-09-11 17:37:15');
INSERT INTO `formulas` VALUES ('4', '1', '1', '29', '1', '4茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '0', '2018-09-11 09:43:01', '2018-09-11 09:43:04');
INSERT INTO `formulas` VALUES ('5', '1', '1', '29', '1', '5茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '0', '2018-09-11 09:43:01', '2018-09-11 09:43:04');
INSERT INTO `formulas` VALUES ('6', '1', '1', '29', '1', '6茉莉绿茶+绿豆+果醋+焦糖浆+燕麦+椰果+芝士奶盖+坚果碎类', '0', '2018-09-11 09:43:01', '2018-09-11 09:43:04');
INSERT INTO `formulas` VALUES ('27', '1', '1', '32', '1', '回甘普洱+可可/黑巧/白巧+红豆+焦糖浆+海盐奶盖', '0', '2018-09-11 15:33:10', '2018-09-11 15:33:10');
INSERT INTO `formulas` VALUES ('28', '1', '1', '32', '2', '茉莉绿茶+椰浆+芒果+果醋+黑糖浆+芝士奶盖', '0', '2018-09-11 15:33:10', '2018-09-11 15:33:10');
INSERT INTO `formulas` VALUES ('29', '1', '1', '31', '1', '回甘普洱+蝶豆花+草莓+薄荷叶+糖浆+海盐奶盖+烤焦糖', '0', '2018-09-11 15:36:46', '2018-09-11 15:36:46');
INSERT INTO `formulas` VALUES ('30', '1', '1', '31', '2', '茉莉绿茶+芒果+配茶+焦糖浆+椰果+芝士奶盖+坚果碎类', '0', '2018-09-11 15:36:46', '2018-09-11 15:36:46');
INSERT INTO `formulas` VALUES ('31', '1', '1', '31', '3', '雨前龙井+燕麦+配茶+焦糖浆+芝士奶盖+坚果碎类', '0', '2018-09-11 15:36:46', '2018-09-11 15:36:46');
INSERT INTO `formulas` VALUES ('32', '1', '1', '30', '1', '雨前龙井+燕麦+果醋+焦糖浆+芝士奶盖+坚果碎类', '0', '2018-09-11 15:37:23', '2018-09-11 15:37:23');
INSERT INTO `formulas` VALUES ('33', '1', '1', '24', '1', '抹茶+全脂奶+玉米+黑糖浆+椰果', '0', '2018-09-11 15:38:15', '2018-09-11 15:38:15');
...
CREATE TABLE `members` (
  ...
  `formula_id` int(11) NOT NULL DEFAULT '0' COMMENT '用户首推配方',
  `openid` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT '微信openID',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员表';

-- ----------------------------
-- Records of members
-- ----------------------------
INSERT INTO `members` VALUES ('1', '1', '彰武巨蜥', '15260988332', 'http://7xru9n.com1.z0.glb.clouddn.com/%E6%99%AE%E6%B4%B1%E8%8C%B6.jpg', '20', '1', '6', '', '2018-08-23 18:06:33', '2018-09-11 15:23:00');
INSERT INTO `members` VALUES ('2', '1', '彰武巨蜥2', '15260988333', 'http://7xru9n.com1.z0.glb.clouddn.com/%E6%99%AE%E6%B4%B1%E8%8C%B6.jpg', '20', '1', '24', '', '2018-08-23 18:06:33', '2018-09-11 14:28:47');
INSERT INTO `members` VALUES ('3', '1', '彰武巨蜥3', '15260988333', 'http://7xru9n.com1.z0.glb.clouddn.com/%E6%99%AE%E6%B4%B1%E8%8C%B6.jpg', '20', '1', '24', '', '2018-08-23 18:06:33', '2018-09-11 14:28:47');
INSERT INTO `members` VALUES ('4', '1', '彰武巨蜥4', '15260988333', 'http://7xru9n.com1.z0.glb.clouddn.com/%E6%99%AE%E6%B4%B1%E8%8C%B6.jpg', '20', '1', '24', '', '2018-08-23 18:06:33', '2018-09-11 14:28:47');
...
INSERT INTO `member_coupons` VALUES ('2', '1', '1', '0', '2018-09-10 10:42:57', '2018-09-10 10:43:00');
...
CREATE TABLE `member_likes` (
  ...
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='会员点赞配方表';

-- ----------------------------
-- Records of member_likes
-- ----------------------------
INSERT INTO `member_likes` VALUES ('1', '1', '2', '2018-09-11 16:59:37', '0000-00-00 00:00:00');
INSERT INTO `member_likes` VALUES ('2', '1', '1', '2018-09-11 17:29:19', '0000-00-00 00:00:00');
INSERT INTO `member_likes` VALUES ('3', '1', '3', '2018-09-11 17:37:15', '0000-00-00 00:00:00');
...
INSERT INTO `migrations` VALUES ('2018_09_07_101306_alert_table_member_add_formula_id', '15');
INSERT INTO `migrations` VALUES ('2018_09_07_101756_alert_table_formula_add_shop_id', '16');
...
INSERT INTO `orders` VALUES ('22', '1', '1', '201809050938528337', '201.00', '201.00', '0.00', '0', '3', '2018-09-05 09:38:52', '10', null, '0', '', '', 'a:2:{i:1;s:6:\"热饮\";i:2;s:6:\"热饮\";}', '2018-09-05 09:38:52', '2018-09-06 16:25:13');
INSERT INTO `orders` VALUES ('23', '1', '1', '201809050951599526', '201.00', '201.00', '0.00', '0', '3', '2018-09-05 09:51:59', '10', null, '0', '', '', 'a:2:{i:1;s:9:\"正常冰\";i:2;s:6:\"少冰\";}', '2018-09-05 09:51:59', '2018-09-06 16:25:46');
INSERT INTO `orders` VALUES ('24', '1', '1', '201809051148554822', '100.00', '100.00', '0.00', '0', '3', '2018-09-05 11:48:55', '10', null, '0', '', '', 'a:1:{i:1;s:6:\"热饮\";}', '2018-09-05 11:48:55', '2018-09-06 16:10:45');
INSERT INTO `orders` VALUES ('25', '1', '1', '201809051415471871', '120.00', '120.00', '0.00', '0', '3', '2018-09-05 14:15:47', '10', null, '0', '', '', 'a:1:{i:1;s:9:\"正常冰\";}', '2018-09-05 14:15:47', '2018-09-06 16:10:51');
...
INSERT INTO `orders` VALUES ('27', '1', '1', '201809051807415241', '121.00', '121.00', '0.00', '0', '3', '2018-09-05 18:07:41', '10', null, '0', '', '-19.00', 'a:1:{i:1;s:8:\"less_ice\";}', '2018-09-05 18:07:41', '2018-09-06 16:25:25');
INSERT INTO `orders` VALUES ('28', '1', '1', '201809061039164624', '121.00', '121.00', '0.00', '0', '3', '2018-09-06 10:39:16', '10', null, '0', '', '39.00', 'a:1:{i:1;s:3:\"hot\";}', '2018-09-06 10:39:16', '2018-09-06 16:25:28');
INSERT INTO `orders` VALUES ('29', '1', '1', '201809061040513563', '162.00', '162.00', '0.00', '0', '1', '2018-09-06 10:40:51', '10', null, '0', '', '104.00', 'a:1:{i:1;s:8:\"less_ice\";}', '2018-09-06 10:40:51', '2018-09-06 11:23:22');
INSERT INTO `orders` VALUES ('30', '1', '1', '201809061129162742', '121.45', '121.45', '0.00', '0', '1', '2018-09-06 11:29:16', '10', null, '0', '', '18.55', 'a:1:{i:1;s:8:\"less_ice\";}', '2018-09-06 11:29:16', '2018-09-06 11:30:22');
INSERT INTO `orders` VALUES ('31', '1', '1', '201809061132339773', '401.45', '401.45', '0.00', '0', '1', '2018-09-06 11:32:33', '10', null, '0', '', '0.00', 'a:3:{i:1;s:3:\"ice\";i:2;s:8:\"less_ice\";i:3;s:8:\"less_ice\";}', '2018-09-06 11:32:33', '2018-09-06 15:14:43');
INSERT INTO `orders` VALUES ('32', '1', '1', '201809061521205348', '220.00', '220.00', '0.00', '0', '1', '2018-09-06 15:21:20', '10', null, '0', '', '', 'a:2:{i:1;s:3:\"hot\";i:2;s:3:\"hot\";}', '2018-09-06 15:21:20', '0000-00-00 00:00:00');
